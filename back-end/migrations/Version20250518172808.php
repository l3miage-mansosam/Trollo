...
final class Version20250518172808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE trello_user (id BINARY(16) NOT NULL COMMENT '(DC2Type:ulid)', role_id BINARY(16) NOT NULL COMMENT '(DC2Type:ulid)', last_name VARCHAR(20) NOT NULL, first_name VARCHAR(20) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(180) NOT NULL, INDEX IDX_User_Role (role_id), UNIQUE INDEX UNIQ_User_Email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
